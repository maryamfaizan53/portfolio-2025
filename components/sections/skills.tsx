...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white">Skills & Expertise</h2>

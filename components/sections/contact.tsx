          ...
          >
            ...
            {contactInfo.map((info, idx) => {
              ...
              return (
                ...
                >
                  <div className="shrink-0 w-12 h-12 rounded-lg bg-primary-100 dark:bg-primary-900 flex items-center justify-center group-hover:bg-primary-600 dark:group-hover:bg-primary-600 transition-all duration-300">
                    <Icon
